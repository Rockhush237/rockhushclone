...
async def get_thumb(videoid):
    ...
    font = ImageFont.truetype("ROCKHUSH/assets/font.ttf", 30)
    title_font = ImageFont.truetype("ROCKHUSH/assets/font3.ttf", 45)
    ...
    play_icons = Image.open("ROCKHUSH/assets/play_icons.png")
