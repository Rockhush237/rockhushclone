...
from ROCKHUSH.utils.database import get_loop
from ROCKHUSH.utils.decorators import AdminRightsCheck
from ROCKHUSH.utils.inline import close_markup, stream_markup, stream_markup2
    ...
    if "live_" in queued:
        ...
        run = await message.reply_photo(
            ...
            caption=_["stream_1"].format(
                f"https://t.me/Naksh_x_musicbot?start=info_{videoid}",
                title[:23],
                check[0]["dur"],
                user,
            ),
