...
from ROCKHUSH import userbot as us, app
...
async def sg(client: Client, message: Message):
    ...
    lol = await message.reply("<code>**ʀᴜᴋᴏ ᴀʙʜɪ ɪsᴋᴀ ᴋᴀᴄʜʜᴀ ᴄʜɪᴛᴛᴀ ɴɪᴋʟᴛᴀ**😈😈...</code>")
    if args:
        try:
            user = await client.get_users(f"{args}")
        except Exception:
            return await lol.edit("<code>ᴋɪsᴋᴀ ᴋᴀʀɴᴀ ʜᴀɪ ʏᴇ ᴛᴏ ʙᴀᴛᴀᴏ Jᴀɴᴀʙ 🤔🤔...</code>")
