...
TAGMES = [ " **❅ बेबी कहा हो। 🤗** ",
           ...
           f" **❅ यहां आ जाओ ना [MERA ADDA](https://t.me/{config.SUPPORT_CHAT}) मस्ती करेंगे 🤭** ",
           " **❅ भूल जाओ मुझे,..? 😊** ",
           " **❅ अपना बना ले पिया, अपना बना ले 🥺** ",
           " **❅ मेरा ग्रुप भी join कर लो ना 🤗** ",
           " **❅ मैने तेरा नाम Dil rakh diya 😗** ",
           " **❅ तुमारे सारे दोस्त कहा गए 🥺** ",
           f" **❅ my cute [owner](https://t.me/{config.OWNER_USERNAME}) 🥰** ",
...
async def mentionall(client, message):
    ...
    if message.reply_to_message and message.text:
        return await message.reply("**ᴀʀᴇ ᴀɪsᴇ ʟɪᴋʜᴏ ɴᴀ ᴘᴀɢᴀʟ ʙᴀʙᴜ »»** /hitag ɢᴏᴏᴅ ᴍᴏʀɴɪɴɢ **ʏᴀ ғɪʀ** »» **ʀᴇᴘʟʏ ᴀɴʏ ᴍᴇssᴀɢᴇ**...")
    elif message.text:
        mode = "text_on_cmd"
        msg = message.text
