...
def admin_required(func):
    ...
    async def wrapper(client, message):
        ...
        if (
            ...
            await message.reply_text("ᴘᴇʀᴍɪssɪᴏɴ ɴᴀʜɪ ʜᴀɪ ʙᴀʙᴜ ᴜ ᴋᴇ ᴘᴀss 👀✨")
            return
    return wrapper
...
async def extract_user_and_reason(message, client):
    ...
    if message.reply_to_message:
        ...
        try:
            ...
            await message.reply_text("ᴍᴜJʜᴇ ᴠᴏ ᴘʀᴀɴɪ ɴᴀʜɪ ᴍɪʟᴀ 🫣✨")
            return None, None, None
    else:
        await message.reply_text("ᴋɪsᴋᴏ ᴋʀɴᴀ ʜᴀɪ ᴜs ᴘᴀʀ ʀᴇᴘʟʏ ʏᴀ ᴜsᴋᴀ ᴜsᴇʀɴᴀᴍᴇ ᴛᴏ ᴅᴀᴀʟɪʏᴇ Jᴀɴᴀʙ 🤔")
        return None, None, None
...
async def ban_command_handler(client, message):
    ...
    try:
        ...
        await message.reply_text("ᴍᴇʀᴇᴋᴏ ʙᴀɴ ʀɪɢʜᴛs ɴᴀʜɪ ᴅɪʏᴇ ʏᴇ ᴋᴀʀɴᴇ ᴋᴇ ʟɪʏᴇ ᴋᴇsᴇ ᴋʀᴜ ??🥺🥺")
    except UserAdminInvalid:
        await message.reply_text("sᴏʀʀʏ, ʏᴀʀʀʀ ᴠᴏ ᴀᴅᴍɪɴ.... ʜᴀɪ ɪsᴋᴏ ɴᴀʜɪ ᴋᴀʀ sᴋᴛᴀ ᴍᴇ ʙᴀɴ 🫡")
...
async def mute_command_handler(client, message):
    ...
    try:
        ...
        await message.reply_text("ᴍᴇʀᴇᴋᴏ ᴍᴜᴛᴇ ʀɪɢʜᴛs ɴᴀʜɪ ᴅɪʏᴇ ʏᴇ ᴋᴀʀɴᴇ ᴋᴇ ʟɪʏᴇ ᴋᴇsᴇ ᴋʀᴜ ??🥺🥺")
    except UserAdminInvalid:
        await message.reply_text("sᴏʀʀʏ, ʏᴀʀʀʀ ᴠᴏ ᴀᴅᴍɪɴ.... ʜᴀɪ ɪsᴋᴏ ɴᴀʜɪ ᴋᴀʀ sᴋᴛᴀ ᴍᴇ ᴍᴜᴛᴇ 🫡")
    except Exception as e:
        await message.reply_text(f"An error occurred: {e}")
...
async def tmute_command_handler(client, message):
    ...
    if not duration:
        await message.reply_text("sᴀʜɪ sᴇ ʟɪᴋʜᴏ ʙᴀʙᴜ ᴀɪsᴇ »» s, m, h, or d for seconds, minutes, hours, or days respectively.")
        return
...
async def kick_command_handler(client, message):
    ...
    try:
        ...
        await message.reply_text("sᴏʀʀʏ, ʏᴀʀʀʀ ᴠᴏ ᴀᴅᴍɪɴ.... ʜᴀɪ ɪsᴋᴏ ɴᴀʜɪ ᴋᴀʀ sᴋᴛᴀ ᴍᴇ ᴋɪᴄᴋ 🫡")
    except Exception as e:
        await message.reply_text(f"An error occurred: {e}")
